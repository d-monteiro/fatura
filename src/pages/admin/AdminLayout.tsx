...
import { Building2, LifeBuoy, AlertTriangle, BarChart3, FileText, ShieldAlert, Users, LogOut, LineChart, Briefcase, RefreshCw } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/admin/sync-jobs', label: 'Sync Jobs', icon: RefreshCw },
