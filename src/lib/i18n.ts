...
const translations = {
  ...
  'inv.nif': { pt: 'NIF' },
  'inv.category': { pt: 'Categoria' },
  'inv.doc_number': { pt: 'N° documento' },
  'inv.amount_net': { pt: 'Valor s/IVA' },
  'inv.iva': { pt: 'IVA' },
  'inv.amount_total': { pt: 'Valor Total' },
  'inv.iva_rate': { pt: 'Taxa IVA' },
  ...
  'inv.autoliquidacao': { pt: 'Autoliquidação IVA' },
  ...
  'upload.ready_desc': { pt: 'Os PDFs serão guardados no Google Drive da conta conectada.' },
  'upload.no_account': { pt: 'Ligue uma conta Google para guardar faturas' },
  'upload.no_account_desc': { pt: 'Os ficheiros ficam no seu Google Drive, organizados por empresa e mês. Ligue uma conta em Definições para começar.' },
  'upload.configure_account': { pt: 'Ligar conta Google' },
  ...
  'drawer.view_file': { pt: 'Ver ficheiro' },
  ...
  'filter.year': { pt: 'Ano' },
  'filter.month': { pt: 'Mês' },
  'filter.category': { pt: 'Categoria' },
  'filter.all_categories': { pt: 'Todas as categorias' },
  'filter.all_years': { pt: 'Todos os anos' },
  'filter.all_months': { pt: 'Todos os meses' },
  'filter.supplier': { pt: 'Fornecedor' },
  'filter.date_from': { pt: 'Desde' },
  'filter.date_to': { pt: 'Até' },
